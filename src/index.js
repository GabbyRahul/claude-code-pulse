...
if (args.includes('--help') || args.includes('-h')) {
  console.log(`
claude-code-pulse - See where your Claude Code tokens go

Usage:
  claude-code-pulse [options]
...
Examples:
  npx claude-code-pulse          Open dashboard in browser
  claude-code-pulse --port 8080  Use custom port
`);
  process.exit(0);
}
...
const server = app.listen(port, '127.0.0.1', async () => {
  ...
  console.log(`\n  claude-code-pulse dashboard running at ${url}\n`);
